...
from region_parameters import get_sierras_24x24_param, plot_points_on_basemap
import matplotlib.pyplot as plt
from mpl_toolkits.basemap import Basemap


if __name__ == '__main__':
    logging.basicConfig(filename=os.path.join('logs','sierras_24.log'),level=logging.INFO)
